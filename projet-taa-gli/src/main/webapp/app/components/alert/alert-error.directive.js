(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('projetTaaGliApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-projetTaaGliApp-error');
                var entityKey = httpResponse.headers('X-projetTaaGliApp-params');
                if (errorHeader) {
